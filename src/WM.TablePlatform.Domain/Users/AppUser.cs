...
namespace WM.TablePlatform.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update TablePlatformDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update TablePlatformEfCoreEntityExtensionMappings to extend the IdentityUser entity
